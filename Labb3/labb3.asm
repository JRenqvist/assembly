...
intgpioe:
	...
	; If value of ones place is 9, add 1 to tens place, otherwise add 1
	; (XX:X9)
    mov  r0,#(0x20001000 & 0xffff)
    movt r0,#(0x20001000 >> 16)
    ldrb r1, [r0]
...
addtensecond:
	...
	; Get the tens place
	; This instruction adds 1 to r0 and stores value of r0+1 in r1
    ldrb r1, [r0, #1]

    ; If tens place is 5, add one to ones minute counter, otherwise add 1
    ; (XX:59)
    cmp r1, #5
    beq addoneminute
...
addoneminute:
	; Same principle as seconds one place.
    mov r1, #0
    strb r1, [r0, #1]
    ldrb r1, [r0, #2]
...
addtenmin:
	; Same principle as seconds tens place
    mov r1, #0
    strb r1, [r0, #2]
    ldrb r1, [r0, #3]
...
resetminute:
	; Gets called when clock is at (59:59). Reset minute tens value since all others already have been reset
    mov r1, #0
    strb r1, [r0, #3]
